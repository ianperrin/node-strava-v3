...
/**
 *
 *    oauth.exchangeToken(code, done)
 *
 * Returns a promise.
 *
 * client ID and secret must be pre-configured.
 *
 * Exchange the authorization code for a refresh token and short-lived access token.
 ...
 *   "state": "STRAVA"
 * }
 *  Ref: https://developers.strava.com/docs/authentication/#token-exchange
 */
oauth.exchangeToken = (code, done) => {
  const options = {
